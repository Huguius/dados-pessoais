...
public class PessoaRestController {
    ...
    @GetMapping("/apelido")
    public PessoaDto findByUsernameRequestParam(@RequestParam(value = "username", defaultValue = "hugojo") String u) {
    ...
    @PutMapping("/{username}")
    public ResponseEntity<PessoaDto> update (@PathVariable  String username, @RequestBody @Valid PessoaDto input){
        PessoaDto pessoa = service.findByUsername(username);
        if (pessoa ==null) {
